...
const slides = ["/1.jpg", "/2.jpg", "/3.jpg", "/4.jpg", "/5.jpg", "/6.jpg", "/7.jpg", "/8.jpg", "/9.jpg", "/10.jpg", "/11.jpg"];
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-gradient-to-br from-[#fff7ec] via-white to-[#fff1e0]">
      {/* Decorative background shapes */}
      <div className="absolute top-0 right-0 -translate-y-1/4 translate-x-1/4 w-[600px] h-[600px] bg-brand/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 translate-y-1/4 -translate-x-1/4 w-[400px] h-[400px] bg-orange-200/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10 py-12 md:py-24">
        ...
        <div className="space-y-8 text-center md:text-left">
          <div className="space-y-4">
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 tracking-tighter leading-[0.9]">
              Handcrafted <br />
              <span className="text-brand">Crochet</span> Magics
            </h2>
            <p className="text-lg md:text-xl text-gray-500 font-medium leading-relaxed max-w-lg mx-auto md:mx-0">
              Unique, high-quality handmade treasures crafted with love and care.
              Bring warmth and a personal touch to your everyday life.
            </p>
          </div>
        ...
        <div className="relative group">
          <div className="absolute -inset-4 bg-brand/5 rounded-[3rem] blur-2xl group-hover:bg-brand/10 transition-colors duration-500" />
