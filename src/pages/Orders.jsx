        ...
        <div className="min-h-screen bg-[#fffcf7] p-4 md:p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    {orders.map((order) => (
                        <div key={order.id} className="bg-white rounded-3xl p-6 shadow-sm border border-orange-50 relative overflow-hidden group">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex flex-wrap gap-2">
                                            {order.items.map((item, idx) => (
                                                <div key={idx} className="bg-gray-50 border border-gray-100 px-3 py-1.5 rounded-xl text-sm font-bold text-gray-700 flex items-center gap-2">
                    ...
                    {orders.length === 0 && (
                        <div className="text-center py-20 bg-white rounded-[2.5rem] border border-dashed border-orange-100 flex flex-col items-center">
