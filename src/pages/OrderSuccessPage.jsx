    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#fffcf7]">
      <div className={`max-w-md w-full text-center transition-all duration-1000 transform ${show ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <div className="relative mb-8 inline-block">
          ...
          <div className="relative bg-white rounded-full p-6 shadow-2xl shadow-brand/10 border border-orange-50">
        ...
        <p className="text-gray-500 text-lg font-medium mb-10 leading-relaxed">
          Thank you for your purchase. Your handcrafted items will be ready soon. You can track your order in your profile.
        </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link
            to="/orders"
            className="bg-white text-gray-700 py-4 px-8 rounded-2xl font-black text-lg border-2 border-orange-50 hover:border-brand hover:text-brand transition-all duration-300 active:scale-95"
          >
            View My Orders
          </Link>
        </div>
