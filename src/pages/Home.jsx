...
export default function Home({ setToast }) {
  ...
  return (
    <div className="bg-[#fffcf7]">
      ...
      <section id="collection" className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          <div>
            ...
            <p className="text-gray-500 font-medium">Unique handcrafted treasures just for you</p>
          </div>
          ...
          <div className="relative group">
            ...
            <input
              className="bg-white border-2 border-orange-50 rounded-2xl px-12 py-3.5 w-full md:w-80 shadow-sm focus:ring-4 focus:ring-brand/10 focus:border-brand outline-none transition-all placeholder:text-gray-300 font-medium"
      ...
      {/* About Section */}
      <section className="relative overflow-hidden bg-white py-24 px-4 border-t border-orange-50">
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-96 h-96 bg-brand/5 rounded-full blur-3xl" />
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-5xl font-black text-gray-800 mb-8 tracking-tighter">About Our Craft</h2>
      ...
      {/* Contact Section */}
      <section className="bg-brand/5 py-24 px-4 relative">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 font-bold">Have a custom request? We'd love to hear from you.</p>
          </div>
